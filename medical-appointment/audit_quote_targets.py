...
def main():
    ...
    for row in rows:
        ...
        records.append({
            ...
            "optimal": optimal, "unconstrained_tiou": unconstrained["tiou"],
            "text_changed": optimal["quote"] != overlap_quote,
        })
    ...
    def summarize(items):
        return {
            ...
            "mean_optimal_unique_tiou": sum(row["optimal"]["tiou"] for row in items) / len(items),
