...
from src.policies.features import FEATURE_VERSION, PUBLIC_FEATURE_VERSION
...
def save_checkpoint(
    ...
    *, inference_only: bool = False,
    ...
    payload = {
        "version": CHECKPOINT_VERSION, "feature_version": (
            PUBLIC_FEATURE_VERSION if config.model.public_context else FEATURE_VERSION
        ),
    ...
    write_json(path.with_suffix(path.suffix + ".json"), {
        ...
        "feature_version": payload["feature_version"], "action_version": ACTION_VERSION,
...
def load_checkpoint(
    ...
    if not isinstance(payload, dict) or (
        ...
        or payload.get("feature_version") not in (FEATURE_VERSION, PUBLIC_FEATURE_VERSION)
    ...
    expected_features = PUBLIC_FEATURE_VERSION if config.model.public_context else FEATURE_VERSION
