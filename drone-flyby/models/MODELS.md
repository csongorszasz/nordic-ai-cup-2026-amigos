...
| 5 | `large_tower` | 13.9 x 12.6 | 19 | 0.771 | brown/camo rectangular structure, pale band across the middle | **fitted: procedural tall tower** (`training/procedural_models.py tall_tower`, no licence needed), IoU 0.78: a solid tapering shaft about 18 m tall on a 4 m base, cabin and pale balcony floor. Seen this obliquely the tower lies across the frame; the CGTrader lattice tower (downloaded, IoU 0.55) leaves gaps the real one does not have |
...
| `large_tower` | [Old wooden watchtower (low poly)](https://www.cgtrader.com/free-3d-models/exterior/other/old-wooden-watchtower-low-poly) | CGTrader | free — **check the licence line** | downloaded (`models/large_tower/cgtrader_watchtower/`, OBJ) — kept as alt; its open lattice legs fit worse than the procedural solid tower |
